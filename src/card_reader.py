...
# of each procedure
procs = {
    'thvsb': ('kinEn', 'zTarget', 'zProj', 'angUnit', 'angStart', 'angEnd', 'mott', 'recoil', 'diracProton', 'impactParameter', 'difCrossSec', 'hoftstadter25', 'hoftstadter125', 'hoftstadter300', 'hoftstadter400', 'hoftstadter550', 'GeigerMarsden')
}
...
def read_card(file_name):
    ...
    # Test for booleans
    for variable in ['mott', 'recoil', 'diracProton', 'impactParameter', 'hoftstadter25', 'hoftstadter125', 'hoftstadter300', 'hoftstadter400', 'hoftstadter550', 'GeigerMarsden']:
